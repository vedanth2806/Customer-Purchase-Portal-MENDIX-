...
public class AzureOAuthHandler implements OAuthHandler {
    ...
    private static final String REAUTHACCIDSEPRATOR = "|ec|";
    private static final String STATE = "state";
    private static final String ACCESS_TOKEN = "access_token";
    private static final String ID_TOKEN = "id_token";
    private static final String SCOPE = String.join("%20", "email", "profile", "openid", "offline_access", "https://outlook.office.com/SMTP.Send");
    private HttpServletResponse servletResponse;
    private HttpServletRequest servletRequest;
    private ISession sessionFromRequest;
    private OAuthProviderDetails providerDetails;
    private StringBuilder oauthUrl = new StringBuilder("https://login.microsoftonline.com/");
	private static final String REDIRECT_URI = OAuthHelper.OAUTHCALLBACKENDPOINT + "azure";
    ...
    @Override
    public Token refreshExpiredToken(Token expiredToken, IContext context) throws IOException {
        ...
        try(CloseableHttpClient httpClient = HttpClientBuilder.create().build()) {
            ...
            if (httpResponse.getStatusLine().getStatusCode() != 200) {
                Core.getLogger("SendEmail").error("refresh token failed " + body);
                return null;
            }
        }
    ...
    private void createPayloadAndRedirectToMxApp(String body) throws CoreException, IOException {
        ...
        oAuthPayload.commit();
        servletResponse.sendRedirect(OAuthHelper.APPROOTURL + "p/oauthprocess_et/" + oAuthPayload.getMendixObject().getId().toLong());
    }
